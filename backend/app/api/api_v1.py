...
from app.routers import aci, auth, cgnat, cpnr, groups, gui, health, inventory, ipmpls, nxos, pbr, systems, telco, terminal, users
...
api_router.include_router(pbr.router)
